      ...
      md:hover:border-lila md:hover:shadow-2xl flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-wrap gap-7 ">
            ...
            <CardRedes pathR="https://www.linkedin.com/company/pulpo-negro-agencia-de-comunicaci%C3%B3n/?viewAsMember=true" rTarget><FontAwesomeIcon icon={faLinkedinIn} className="text-lila group-hover:text-white" /></CardRedes>
            <CardRedes pathR="https://mail.google.com/mail/?view=cm&fs=1&to=unpulponegro@gmail.com" rTarget><FontAwesomeIcon icon={faEnvelope} className="text-lila group-hover:text-white" /> </CardRedes>
          </div>
        </div>
    </FadeIn>
