...
export const CardServicios = ({ label, iconS, description }: CardServiciosProps) => {
  return (
    <div className="w-90 h-40 rounded-2xl grid grid-cols-5 bg-fondo p-3 gap-10 shadow-[9px_9px_16px_#cbd5e1,-9px_-9px_16px_#ffffff]">
        <div className="col-span-3 flex flex-col gap-4 justify-center w-full">
            <h3 className="text-2xl font-bold text-shadow-2xs border-b-4 border-b-lila">{label}</h3>
