...
export default function HeroServicios() {
  return (
    <section id="inicioNosotros" className="relative w-full flex flex-col md:flex-row md:gap-10 px-5 py-5 md:py-5 md:px-[5%] mx-auto
            md:h-[calc(100vh-160px)] items-center justify-center md:justify-start">
        <div className="md:grid md:grid-cols-12 flex flex-col gap-6 md:gap-6 items-center justify-center">
          ...
          <div className="md:col-span-8 flex flex-wrap justify-center gap-5">
            <SeccionServicios />
          </div>
        </div>
    </section>
